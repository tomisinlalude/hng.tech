...
<body>
    ...
    <header class="header">
        <nav class="navmenu">
            <div>
             <a href="https://hng.tech"><img src="img/Logo.png" alt="HNG Tech"></a>
            </div>
            <div>
    ...
    <section class="our_services">
        ...
        <div class="service_box">
            <div class="py-4 service-img-box">
                <img class="service_img" src="img/asset2_agbo.png" alt="">
            </div>
...
<!--  
    <section style="text-align: center" class="testimony mb-5">
        ...
        <div>
            ...
            <div>
                <div class="d-flex justify-content-center"><img src="img/avatar.png" alt="" class="img-thumbnail testimony_avatar"></div>
       ...
       <div>
            ...
            <div style="background-colo: red;">
                <div class="d-flex justify-content-center"><img src="img/avatar2.jpg" alt="" class="img-thumbnail testimony_avatar"></div>
                <div class="avatar_caption">
                <p>David Jackson</p>
                </div>
            </div>
       ...
       <div>
            ...
            <div>
                 <div class="d-flex justify-content-center"><img src="img/avatar3.jpg" alt="" class="img-thumbnail testimony_avatar"></div>
                <div class="avatar_caption">
                <p>Matt Phil</p>
                </div>
            </div>
...
-->
    ...
    <section class="contact_us">
        <div>
            <a href="https://hng.tech"><img class="mb-3" src="img/Logo.png" alt="HNG Tech"></a>
            <p>
