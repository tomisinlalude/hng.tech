...
<body>
	...
	<div class="container gridContainer">
		<div class="row center-block">
			<a href="#" class="col-sm-6 col-lg-4 col-lg-offset-2" id="productAnime">
				<div class="jumbotron product  col-lg-4 col-md-4 ">
			...
			<a href="#" class=" col-sm-6 col-lg-4" id="productAnime">

				<div class="jumbotron product  col-lg-4 col-md-4 text-center">

					<img src="https://res.cloudinary.com/dx6ol2ale/image/upload/v1557356084/ziki_color.svg" alt="Ludic-logo-color" class="imgCenter center-block" style="width:20%;">
					<div id="extra">
						<img src="https://res.cloudinary.com/dx6ol2ale/image/upload/v1557355907/ziki_white.svg" alt="Lucid-logo-white" class=" centre-block" style="width:20%; margin: 50px 0px 0px 0px;">
		...
		<div class="row center-block">
			<a href="#" class="col-sm-6 col-lg-4 col-lg-offset-2" id="productAnime">
				<div class="jumbotron product  col-lg-4 col-md-4 ">
					...
					<img src="https://res.cloudinary.com/dx6ol2ale/image/upload/v1556547608/devalertlogo.jpg" alt="devalert-logo" class="imgCenter center-block" style="width:30%;">
					<div id="extra">
			...
			<a href="#" class="col-sm-6 col-lg-3" id="productAnime">
				<div class="jumbotron product col-lg-4" >
					...
					<div id="extra">
						<img src="https://res.cloudinary.com/dx6ol2ale/image/upload/v1556806436/Kidslogo.png" alt="" class=" centre-block" style="width:50%; margin: 50px 0px 0px 75px;">
