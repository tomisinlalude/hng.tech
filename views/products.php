...
<body>
	...
	<div class="container gridContainer" style="margin-bottom: 15rem;">
		<div class="row">
			<a href="#" id="apoe">
				<div class="jumbotron product col-lg-4 col-md-6" style="position: relative; z-index: 2;">
					<!-- <span class="container-fluid detail" style="position: absolute;">
