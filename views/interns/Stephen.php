               ...
               <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="col-md-6 col-xs-12">
                     <div class="intern-block border-blue">
                        <img src="https://res.cloudinary.com/dhp5ouskx/image/upload/v1554491416/IMG_20180808_111911-1.jpg
" alt="Stephen Madubuike">
                        <h6>Stephen Madubuike</h6>
                        <p>Back-end Developer</p>
                        <ul class="list">
                           <li><a href="#" target="_blank"<i class="fab fa-twitter fa-2x"></i></a></li>
                           <li><a href="https://github.com/decolt" target="_blank"<i class="fab fa-github fa-2x"></i></a></li>
