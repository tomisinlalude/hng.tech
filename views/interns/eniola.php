               ...
               <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="col-md-6 col-xs-12">
                     <div class="intern-block border-blue">
                        <img src="https://res.cloudinary.com/eniolajohnson/image/upload/v1554453036/eniolajohnson.jpg" alt="Eniola Johnson">
                        <h6>Eniola Johnson</h6>
                        <p>Data Scientist</p>
                        <ul class="list">
                  ...
                  <div class="col-md-6 col-xs-12 align-items-center">
                     <div class="intern-bio border-blue">
                        <h6>About me</h6>
                        <p>Writer. I write codes.</p>
                        <br />
                        <h6>Skills</h6>
                        <p>Data Science | Git | Python</p>
                     </div>
                  </div>
               </div>
            </div>
