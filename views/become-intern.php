...
<html>
			...
			<div class="row bi-header">
				<div class="col-md-7 bi-header-images">
					<div class="bi-header-image1">
						<img src="../app/img/become-intern/female-phone.jpg" alt="lady with phone" >
					...
					<div class="bi-header-image2">
						<img src="../app/img/become-intern/male-laptop.jpg" alt="Male with laptop">
					</div>
				</div>
						...
						<div class="bi-stats-info">
							...
							<div class="bi-stats-twitter">
								...
								<div class="bi-stats-icon">
									...
									<img src="../app/img/twitter-white.svg"/>
									</a>
								</div>
							</div>
						</div>
			...
			<div class="container">
				<div class="row bi-others">
					...
					<div class="bi-others-img">
						<img src="../app/img/become-intern/interns4.jpg">
					</div>
				</div>
			</div>
		</div>
	...
	<?php include 'partials/priceModal.php';?>
